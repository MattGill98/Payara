...
import fish.payara.notification.admin.BaseSetNotifierConfiguration;
...
@RequestTracingNotifier(name = "requesttracing-datadog-notifier-configure")
@HealthCheckNotifier(name = "healthcheck-datadog-notifier-configure")
@PerLookup
