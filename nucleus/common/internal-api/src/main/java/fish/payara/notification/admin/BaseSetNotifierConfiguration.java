 ...
 * holder.
 */
package fish.payara.notification.admin;
...
import fish.payara.notification.annotations.HealthCheckNotifier;
import fish.payara.notification.annotations.RequestTracingNotifier;
...
public abstract class BaseSetNotifierConfiguration<NC extends PayaraNotifierConfiguration, N extends PayaraNotifier> implements AdminCommand {
    ...
    private String getHealthCheckNotifierCommandName() {
        HealthCheckNotifier annotation = service.getClass().getAnnotation(HealthCheckNotifier.class);
        if (annotation != null) {
    ...
    private String getRequestTracingNotifierCommandName() {
        RequestTracingNotifier annotation = service.getClass().getAnnotation(RequestTracingNotifier.class);
        if (annotation != null) {
            return annotation.name();
        }
        return null;
